...
[![CI](https://github.com/Roberdan/convergio-db/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-db/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-db/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-db] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-db = { git = "https://github.com/Roberdan/convergio-db", tag = "v0.1.0" }
```
